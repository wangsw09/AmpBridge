...
def test_amp_mse_Lq():
    ...
    assert abs(wrapper.mse_Lq(3, 2, 1, 0.2, 1.6, tol) - 0.1979671744) < TOL
    assert abs(wrapper.mse_Lq(3, 2, 1, 0.2, 1.9, tol) - 0.2187358052) < TOL
    assert abs(wrapper.mse_Lq(3, 2, 1, 0.2, 2) - 0.2285714285714286) < TOL
    assert abs(wrapper.mse_Lq(3, 2, 1, 0.2, 2.1, tol) - 0.2395230168) < TOL
    assert abs(wrapper.mse_Lq(3, 2, 1, 0.2, 2.9, tol) - 0.3497210456) < TOL
    assert abs(wrapper.mse_Lq(3, 2, 1, 0.2, 4.0, tol) - 0.5138177753) < TOL
...
def test_amp_mse_Lq_dalpha():
    ...
    assert abs(wrapper.mse_Lq_dalpha(3, 2, 1, 0.2, 1.6, tol) + 0.0141753036) < TOL
    assert abs(wrapper.mse_Lq_dalpha(3, 2, 1, 0.2, 1.9, tol) + 0.0283831325) < TOL
    assert abs(wrapper.mse_Lq_dalpha(3, 2, 1, 0.2, 2) + 0.032653061224) < TOL
    assert abs(wrapper.mse_Lq_dalpha(3, 2, 1, 0.2, 2.1, tol) + 0.0366141033) < TOL
    assert abs(wrapper.mse_Lq_dalpha(3, 2, 1, 0.2, 2.9, tol) + 0.0579590031) < TOL
    assert abs(wrapper.mse_Lq_dalpha(3, 2, 1, 0.2, 4.0, tol) + 0.0682916797) < TOL
...
def test_amp_tau_of_alpha():
    ...
    assert abs(wrapper.tau_of_alpha(3, 1, 1.6, 0.2, 0.8, 2.0, tol) - 2.06151442629) < TOL
    assert abs(wrapper.tau_of_alpha(3, 1, 1.9, 0.2, 0.8, 2.0, tol) - 2.06864155408) < TOL
    assert abs(wrapper.tau_of_alpha(3, 1, 2.0, 0.2, 0.8, 2.0, tol) - 2.0720023449) < TOL
    assert abs(wrapper.tau_of_alpha(3, 1, 2.1, 0.2, 0.8, 2.0, tol) - 2.07575578482) < TOL
    assert abs(wrapper.tau_of_alpha(3, 1, 2.9, 0.2, 0.8, 2.0, tol) - 2.11466606311) < TOL
    assert abs(wrapper.tau_of_alpha(3, 1, 4.0, 0.2, 0.8, 2.0, tol) - 2.1772734091) < TOL
...
def test_amp_optimal_alpha():
    ...
    assert abs(wrapper.optimal_alpha(1, 1.6, 0.2, 0.8, 2.0, tol) - 4.7669989594) < TOL
    assert abs(wrapper.optimal_alpha(1, 1.9, 0.2, 0.8, 2.0, tol) - 8.52218739836) < TOL
    assert abs(wrapper.optimal_alpha(1, 2.0, 0.2, 0.8, 2.0, tol) - 10.5968388268) < TOL
